...
OUTPUT_PORT = "/dev/tty.usbmodemC3760711"
BRAINSTEM_OUTPUT_PORT = 0
INPUT_PORT = "/dev/tty.usbmodemC3760713"
...
for x in range(0, 10):
    ...
    numBytesWritten = serialOutput.write('Testing...')
    print "%d Bytes were written to serial port: \"%s\"" % (numBytesWritten, OUTPUT_PORT)


    print "Reading from port:"
    print "The following were read from port: \"%s\": \"%s\"" % (INPUT_PORT, serialInput.read(numBytesWritten))
